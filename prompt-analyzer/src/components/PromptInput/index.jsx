...
import { FileText, RefreshCw, Target, Download } from 'lucide-react';

export default function PromptInput({ promptText, setPromptText, analyzePrompt, isAnalyzing, analysis, downloadJSON, hideStats }) {
  return (
    <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 md:p-8 flex flex-col h-full border border-white/20 shadow-2xl">
      ...
      />
      {/* Botões de ação */}
      <div className="flex flex-col sm:flex-row justify-end items-end gap-4 mt-4 flex-1">
        <div className="flex gap-3 w-full sm:w-auto">
          ...
          {analysis && (
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 bg-green-500 hover:bg-green-600 text-white rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 w-full sm:w-auto"
            >

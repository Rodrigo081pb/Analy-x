  ...
  return (
    <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
      {filteredHistory.length === 0 ? (
        ...
        <div className="flex flex-col gap-6 max-h-96 overflow-y-auto py-2">
          {filteredHistory.map((item, index) => (
            <div key={item.id} className="bg-gradient-to-r from-purple-900/40 to-pink-900/30 rounded-2xl p-6 border border-white/10 shadow-lg hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 group flex flex-col gap-2 mx-0 first:mt-0 last:mb-0">
